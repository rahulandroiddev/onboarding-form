...
import { ChakraProvider, Box, Heading, Container, VStack, Text, HStack, Badge, Image } from '@chakra-ui/react';
          ...
          {testimonials.map((testimonial, index) => (
            <Box key={index} borderWidth="1px" borderRadius="lg" p={4} w="full">
              <HStack justifyContent="space-between" mb={2}>
                ...
                <Badge colorScheme="teal">{testimonial.comments} Comments</Badge>
              </HStack>
              <HStack mb={2}>
                <Image
                  borderRadius="full"
